...
public class AppointmentFixtures {
    ...
    public static final BigDecimal 수현_약속_위도 = BigDecimal.valueOf(37.5280674292228);
    public static final BigDecimal 수현_약속_경도 = BigDecimal.valueOf(126.99597295767953);
